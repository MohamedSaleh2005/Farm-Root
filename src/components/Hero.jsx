...
const Hero = () => {
  return (
    <section className="min-h-[90vh] flex flex-col-reverse lg:flex-row justify-center gap-12 lg:justify-between items-center mt-10 px-5 lg:px-14 bg-gradient-to-r from-[#d7e8dc] to-[#c4dbce]">
      {/* content section  */}
      <div className=" text-center md:text-start space-y-5 max-w-xl">
